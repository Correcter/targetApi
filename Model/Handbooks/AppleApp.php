...
class AppleApp
{
    ...
    /**
     * @Assert\NotBlank(message="Идентификатор приложения в AppStore обязателено для заполнения")
     * @Assert\Type(
     *     type="string",
     *     message="Идентификатор приложения в AppStore {{ value }} имеет неверный тип {{ type }}."
     * )
     *
     * @var string
     */
